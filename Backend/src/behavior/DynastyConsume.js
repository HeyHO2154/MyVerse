class DynastyConsume {
  ...
  static consume(dynasty, market) {
    ...
    if(dynasty.money > 0) this.consumeItem(dynasty, market, '옷'); else console.log("옷 자금 부족");
    if(dynasty.money > 0) this.consumeItem(dynasty, market, '술'); else console.log("술 자금 부족");
  }
